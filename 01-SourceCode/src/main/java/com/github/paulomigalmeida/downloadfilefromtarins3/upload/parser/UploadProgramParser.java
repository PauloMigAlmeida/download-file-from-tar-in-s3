...
public class UploadProgramParser extends AbstractBaseParser {
    ...
    public void run(String[] args) {
        ...
        try {
            ...
            UploadProgramArgumentsSingleton.getInstance().setBucketName(line.getOptionValue("aws_bucket_name"));
            UploadProgramArgumentsSingleton.getInstance().setKeyName(line.getOptionValue("aws_key_name"));
            UploadProgramArgumentsSingleton.getInstance().setFile(new File(line.getOptionValue("file")));
